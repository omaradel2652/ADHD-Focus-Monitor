  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var REMOTE_PACKAGE_BASE = (typeof chrome !== 'undefined' && chrome.runtime && chrome.runtime.getURL) 
        ? chrome.runtime.getURL('mediapipe/face_mesh_solution_packed_assets.data') 
        : 'face_mesh_solution_packed_assets.data';
      if (typeof Module['locateFilePackage'] === 'function' && !Module['locateFile']) {
        Module['locateFile'] = Module['locateFilePackage'];
        err('warning: you defined Module.locateFilePackage, that has been renamed to Module.locateFile (using your locateFilePackage for now)');
      }
      var REMOTE_PACKAGE_NAME = 'chrome-extension://ncakhiiakalbddlecnfofiinhejahbff/mediapipe/face_mesh_solution_packed_assets.data';
